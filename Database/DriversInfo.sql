...
BEGIN
    ...
    SELECT summary
    FROM (SELECT CONCAT(' Total miles driven by all drivers combined: ', SUM(miles_logged)) AS summary,
                 0                                                                          AS collect
          FROM inspections
          UNION
          ...
          UNION
          SELECT CONCAT('  date: ', date, '; miles covered: ', miles_logged) AS summary,
